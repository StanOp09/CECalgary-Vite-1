...
//   // );
//   return (
//     <div className="w-full min-h-screen bg-yellow-50 p-4">
//       <GivingHero />
  ...
  return (
    <div className="w-full pb-12 min-h-screen ">
      ...
      <div className="flex justify-center px-4 -mt-10">
        <div className="w-full max-w-4xl backdrop-blur rounded-xl p-6">
          <ManageGiving />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {givingCategories.map((cat) => (
            <GivingCard
              ...
              description={cat.description}
              Icon={cat.icon}
              bgColor={`${cat.bgColor} hover:scale-105 transition-transform duration-300`}
            />
          ))}
        </div>
      </div>
